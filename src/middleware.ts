...
export const config = {
  matcher: [
    ...
    '/',
    '/(en|fr|ar)/:path*',
    // Exclude static assets, sitemap/robots, and Next.js internals
    '/((?!api/|_next/static|_next/image|favicon\\.ico|site\\.webmanifest|sitemap\\.xml|robots\\.txt|.*\\.(?:svg|png|jpg|jpeg|gif|webp|ico)$).*)',
  ],
};
